...
class ELMoEmbedder(Component):
    ...
    Parameters:
        ...
        elmo_output_names: A list of output ELMo. You can use combination of ["word_emb", "lstm_outputs1", "lstm_outputs2","elmo"] and you can use separately ["default"].
        See `TensorFlow Hub <https://www.tensorflow.org/hub/overview>`__ for more information about it.
