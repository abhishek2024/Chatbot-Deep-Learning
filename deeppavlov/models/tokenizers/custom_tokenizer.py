...
from deeppavlov.models.tokenizers.utils import detokenize, ngramize_new, replace, replace_digits
from deeppavlov.core.common.log import get_logger

logger = get_logger(__name__)


@register('custom_tokenizer')
class CustomTokenizer(Component):
    ...
    def _pipe(self, items, entities, ngram_range=(1, 1)):
        """
