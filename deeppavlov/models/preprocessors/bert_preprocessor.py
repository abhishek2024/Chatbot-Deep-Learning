...
import numpy as np
from bert_dp.preprocessing import convert_examples_to_features, _truncate_seq_pair, InputExample, InputFeatures
...
class BertRankerPreprocessor(BertPreprocessor):
    ...
    def __call__(self, batch: List[List[str]]) -> List[List[InputFeatures]]:
        ...
        for s in cont_resp_pairs:
            ...
            examples.append(ex)
        features = [get_features(el, self.max_seq_length, self.tokenizer) for el in examples]
